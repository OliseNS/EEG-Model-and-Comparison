...
for channel in channels:
    ...
    prediction2 = clf.predict(test2_X)
    ...
    plt.savefig(f'OUTPUT/SVM/confusion_matrix_{channel}.png')  # Save the figure
    plt.close()
    ...
    plt.savefig(f'OUTPUT/SVM/Metrics_{channel}.png')  # Save the figure
    plt.close()
